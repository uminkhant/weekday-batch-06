				...
				<div class="card col-sm-6 p-2">
					...
					<div class="card-body p-2 mb-2">
						...
						<c:if test="${not empty m and m.role == 'ADMIN' }">
							<div class="form-group mb-2 text-start">
								<label for="name" class="form-label text-color ">Role </label>
						...
						<div class="form-group mb-2 text-start">
							<label for="dt" class="form-label text-color">LoginId</label> <input
								id="dt" type="text" class="form-control" name="loginId" required/>
						</div>
						<div class="form-group mb-2 text-start">
							<label for="ws" class="form-label text-color">Password</label> <input
								id="ws" type="password" class="form-control" name="password" required/>
						</div>
						<div class="form-group mb-2 text-start">
					...
					<div class="card-body p-2 mb-2">
						...
						<div class="form-group mb-2 text-start">
							<label for="phone" class="form-label text-color">Phone</label> <input
								id="phone" type="text" class="form-control" name="phone" required/>
						</div>
					</div>
